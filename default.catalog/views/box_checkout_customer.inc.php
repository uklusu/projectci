<section id="box-checkout-customer" class="box">
  ...
  <div style="float:right">
    <button class="btn btn-default btn-primary" href="<?php echo document::ilink('login', array('redirect_url' => document::ilink('checkout'))) ?>" data-toggle="lightbox" data-require-window-width="768"><?php echo language::translate('title_sign_in', 'Sign In'); ?></button>
  </div>
  <?php } ?>
