...
<link rel="stylesheet" href="{snippet:template_path}css/custom.min.css" />
<link rel="stylesheet" href="https://static.litecart.net/assets/fontawesome/font-awesome.min.css?_=1613532126" />
{snippet:head_tags}
{snippet:style}
</head>
<body>
...
<a id="scroll-up" class="hidden-print" href="#">
  <?php echo functions::draw_fonticon('fa-chevron-circle-up', 'style="color: #000;"'); ?>
</a>
